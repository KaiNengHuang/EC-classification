...
def init():
    ...
    data = loadmat(r"../../data/differentDataset/removeCovCombatEC.mat").get('removeCovCombatEC')
    label=loadmat(r"../../data/differentDataset/label.mat").get('label')
