...
def run():
    ...
    for train_index, test_index in kfold.split(data, label):
        ...
        # joblib.dump(svm, "../visualizationAnalysis/svm" + str(cnt) + ".pkl")
        #
        ...
        joblib.dump(gbm, "../visualizationAnalysis/lightgbm" + str(cnt) + ".pkl")
